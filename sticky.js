...
! function(e) {
    ...
    var e = function(e) {
        function n() {
            g = window.requestAnimationFrame(scrollPlay) || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
